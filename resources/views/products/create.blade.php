            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="barcode" id="barcode"
                           ...
                           value="{{ old('barcode') }}" maxlength="100" required autofocus>
                    @error('barcode')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="product_name" id="product_name"
                           ...
                           value="{{ old('product_name') }}" maxlength="150" required>
                    @error('product_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
...
@push('scripts')
<script>
    // Mapa: subcategoría -> unidades permitidas (ya existía)
    const subCategoryUnits = @json($subCategoryUnits);

    // Mapa nuevo: categoría -> lista de subcategorías {id, name}
    ...
    function updateUnitOptions() {
        ...
        // Si solo hay una unidad permitida, se selecciona sola
    ...
    // Si el formulario vuelve por un error de validación, restauramos la selección anterior
    ...
    if (oldCategoryId) {
        ...
        if (oldSubCategoryId) {
            ...
            updateUnitOptions();
            if (oldUnitId) unitSelect.value = oldUnitId;
        }
    }
